defmodule MyUploadAppWeb.TaskLiveTest do
  use MyUploadAppWeb.ConnCase

  import Phoenix.LiveViewTest
  import MyUploadApp.TasksFixtures

  @create_attrs %{title: "some title", completed: true, due_date: "2023-11-08"}
  @update_attrs %{title: "some updated title", completed: false, due_date: "2023-11-09"}
  @invalid_attrs %{title: nil, completed: false, due_date: nil}
